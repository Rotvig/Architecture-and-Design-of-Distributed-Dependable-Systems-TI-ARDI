...
The publish/subscribe pattern will be implemented as topic-based. This approach allows the possibility of easily dividing different blackjack tables in different topics. The topics will in this project use URL like strings.
