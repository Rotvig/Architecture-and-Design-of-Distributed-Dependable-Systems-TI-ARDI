...
The client has a graphical user interface created with WPF. This is the MainView. Here the user can bet, see the dealed cards and choose to stand, ask for more cards. 
...
\subsection{Class diagram}
The server also has a graphical user interface created with WPF. This is called the MainView. Through the MainView the dealer can start a new game and see the dealers card. The dealer uses the Utils class to shuffle the cards. 
