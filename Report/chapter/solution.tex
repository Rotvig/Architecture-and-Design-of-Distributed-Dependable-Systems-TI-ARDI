...
\myFigure{SequenceDiagramClient}{Client sequence diagram }{fig:client_sq}{0.95}
\FloatBarrier
...
After the game has started Players can bet. In this sequence diagam only on Player is playing at the table and only one bet event is received. After the Dealer has received bets it hands out cards by publishing the message. 
